    ...
    public function run()
    {
        ...
        $permissoes = [
            [
                ...
                'permissoes' => json_encode(['vNFSe' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                ...
                'permissoes' => json_encode(['cNFSe' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                'idPermissao' => null,
                'nome' => 'Editar NFSe (OS)',
                'permissoes' => json_encode(['eNFSe' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                ...
                'permissoes' => json_encode(['vBoletoOS' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                ...
                'permissoes' => json_encode(['cBoletoOS' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                ...
                'permissoes' => json_encode(['eBoletoOS' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
            [
                'idPermissao' => null,
                'nome' => 'Relatório NFSe',
                'permissoes' => json_encode(['rNFSe' => 1]),
                'situacao' => 1,
                'data' => date('Y-m-d'),
            ],
        ];
