...
$route['certificado/download_xml/(:num)'] = 'certificado/download_xml/$1';
$route['certificado/visualizar_xml/(:num)'] = 'certificado/visualizar_xml/$1';
$route['certificado/imprimir_nfse_importada/(:num)'] = 'certificado/imprimir_nfse_importada/$1';
...
$route['nfse_os/preview_boleto/(:num)'] = 'nfse_os/preview_boleto/$1';
$route['nfse_os/preview_boleto_emissao/(:num)/(:num)'] = 'nfse_os/preview_boleto_emissao/$1/$2';
...
// Rotas de Configuracoes de Notificacoes WhatsApp
...
$route['notificacoes/adicionar_template'] = 'notificacoesConfig/adicionar_template';
