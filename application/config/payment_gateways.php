...
$config['payment_gateways'] = [
    ...
    'Cora' => [
        ...
        'credentials' => [
            'client_id' => $_ENV['PAYMENT_GATEWAYS_CORA_CREDENTIALS_CLIENT_ID'] ?? '',
            'client_secret' => $_ENV['PAYMENT_GATEWAYS_CORA_CREDENTIALS_CLIENT_SECRET'] ?? '',
        ],
        'boleto_expiration' => $_ENV['PAYMENT_GATEWAYS_CORA_BOLETO_EXPIRATION'] ?? 'P3D',
        'fine_percentage' => floatval($_ENV['PAYMENT_GATEWAYS_CORA_FINE_PERCENTAGE'] ?? 2.00), // Multa padrão: 2%
        'interest_percentage' => floatval($_ENV['PAYMENT_GATEWAYS_CORA_INTEREST_PERCENTAGE'] ?? 0.033), // Juros diário: 0.033%
        'payment_methods' => [
            [
        ...
        'transaction_status' => [
            'DRAFT' => 'Cobrança em rascunho',
            'OPEN' => 'Cobrança gerada, aguardando pagamento',
            'PAID' => 'Pagamento recebido',
            'CANCELLED' => 'Cobrança cancelada',
            'IN_PAYMENT' => 'Pagamento em processamento',
            'LATE' => 'Cobrança vencida',
            'PENDING' => 'Aguardando pagamento',
