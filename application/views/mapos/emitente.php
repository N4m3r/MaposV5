        ...
        <div class="col-12">
            <div class="widget-box">
                ...
                <div class="widget-content ">
                    ...
                    <a href="#modalCadastrar" data-bs-toggle="modal" role="button" class="button btn btn-success"> <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Cadastrar Dados</span></a>
                </div>
            </div>
        </div>
    </div>
