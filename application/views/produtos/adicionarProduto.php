                    ...
                    <div class="row" style="margin:0">
                        <div class="col-md-6" style="padding:0 15px">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="codDeBarra" type="text" name="codDeBarra" value="<?php echo set_value('codDeBarra'); ?>" placeholder="Código de barras">
                            </div>
                            <div class="mb-3">
                                <label for="descricao" class="form-label">Descrição <span class="required">*</span></label>
                                <input id="descricao" type="text" name="descricao" value="<?php echo set_value('descricao'); ?>" placeholder="Nome ou descrição do produto">
                            </div>
                            <div class="mb-3">
                                <label for="precoCompra" class="form-label">Preço de Compra <span class="required">*</span></label>
                                <input id="precoCompra" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoCompra" value="<?php echo set_value('precoCompra'); ?>" placeholder="R$ 0,00">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group-inline">
                                    <input id="precoVenda" class="money" data-affixes-stay="true" data-thousands="" data-decimal="." type="text" name="precoVenda" value="<?php echo set_value('precoVenda'); ?>" placeholder="R$ 0,00">
                        ...
                        <div class="col-md-6" style="padding:0 15px">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input id="estoque" type="text" name="estoque" value="<?php echo set_value('estoque'); ?>" placeholder="Quantidade">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="estoqueMinimo" class="form-label">Estoque Mínimo</label>
                                    <input id="estoqueMinimo" type="text" name="estoqueMinimo" value="<?php echo set_value('estoqueMinimo'); ?>" placeholder="Qtd mínima">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tipo de Movimento</label>
                                <div style="display:flex;gap:10px;flex-wrap:wrap">
                                    <label for="entrada" class="form-check-label-custom">Entrada
                                        <input type="checkbox" id="entrada" name="entrada" class="badgebox" value="1" checked>
                                        <span class="badge">&#10003;</span>
                                    </label>
                                    <label for="saida" class="form-check-label-custom">Saída
