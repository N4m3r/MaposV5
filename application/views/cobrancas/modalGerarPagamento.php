        ...
        <form id="form-gerar-cobranca" name="cobranca" method="post" action="<?php echo base_url() . 'index.php/cobrancas/adicionar'; ?>">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="forma-pag" class="">
                        <div class="form-group">
                            ...
                            <select id="gateway_de_pagamento" class="form-control col-12" name="gateway_de_pagamento" required>
                            ...
                            <select id="forma_pagamento" class="form-control col-12" name="forma_pagamento" required hidden>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div>
                        <button id="payment" type="submit" class="button btn btn-sm btn-info" style="float: right;">
