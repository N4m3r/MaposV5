...
<div class="form-unified">
    <div class="form-header">
        <div class="form-header-content">
            <div>
                ...
                <p><?= svg_icon('chevron-left', 16, 16) ?> <a href="<?php echo site_url('obras'); ?>" class="form-header-link">Voltar para lista</a></p>
            </div>
            <?php if (isset($result)): ?>
            <div class="form-header-code">
                <div class="form-header-code-label">Código</div>
                <div class="form-header-code-value">#<?php echo $result->id; ?></div>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <form method="post" action="<?php echo isset($result) ? site_url('obras/editar/' . $result->id) : site_url('obras/adicionar'); ?>" id="formObra">
        ...
        <div class="form-card">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="cliente_id" id="cliente_select" class="form-select<?php echo isset($result) ? ' form-select-disabled' : ''; ?>" required <?php echo isset($result) ? 'disabled' : ''; ?>>
                    ...
                    <?php endif; ?>
                    <div id="cliente_info" class="form-cliente-info">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-icon form-card-icon-green"><?= svg_icon('map', 22, 22) ?></div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-icon form-card-icon-pink"><?= svg_icon('user', 22, 22) ?></div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <small class="form-status-hint">
                        <?= svg_icon('info-circle', 14, 14) ?> Status atual: <strong><?php echo htmlspecialchars($result->status); ?></strong>
                        <span class="form-status-mapped">(mapeado para: <?php echo $status_selecionado; ?>)</span>
                    </small>
                </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-icon form-card-icon-yellow"><?= svg_icon('comment', 22, 22) ?></div>
