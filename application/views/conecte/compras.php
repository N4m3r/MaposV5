            ...
            <table id="tabela" class="table table-bordered ">
                ...
                <tbody>
                    ...
                    switch ($r->status) {
                        ...
                        echo '<td class="text-nowrap"><a href="' . base_url('index.php/mine/visualizarCompra/' . $r->idVendas) . '" class="btn-action btn-action-view" title="Ver mais detalhes">' . svg_icon('eye', 16, 16) . '</a>
                      <a href="' . base_url('index.php/mine/imprimirCompra/' . $r->idVendas) . '" class="btn-action btn-action-print" title="Imprimir" target="_blank">' . svg_icon('printer', 16, 16) . '</a>
                  </td>';
                        echo '</tr>';
                    } ?>
                </tbody>
