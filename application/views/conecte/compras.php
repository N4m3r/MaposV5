            ...
            <table id="tabela" class="table table-bordered ">
                ...
                <tbody>
                    ...
                    switch ($r->status) {
                        ...
                        echo '<td><a href="' . base_url('index.php/mine/visualizarCompra/' . $r->idVendas) . '" class="btn-nwe" title="Ver mais detalhes">' . svg_icon('eye', 16, 16) . '</a>
                      <a href="' . base_url('index.php/mine/imprimirCompra/' . $r->idVendas) . '" class="btn-nwe6" title="Imprimir" target="_blank">' . svg_icon('printer', 16, 16) . '</a>
                  </td>';
                        echo '</tr>';
                    } ?>
                </tbody>
