...
<body>
            ...
            <div class="widget-content nopadding tab-content">
                <form action="<?php echo base_url() . 'index.php/mine/tokenManual' ?>" id="formCliente" method="post" class="form-horizontal">
                    ...
                    <div class="mb-3" style="display: flex;margin-bottom: 7pxpx;grid-column-gap: 5px;justify-content: space-evenly">
                        <label style="width: auto" for="token" class="form-label">Token<span class="required">*</span></label>
    ...
    <!--Footer-part-->
    <div class="row">
        <div id="footer" class="col-12" style="padding: 10px"> <a class="pecolor btn" href="https://github.com/RamonSilva20/mapos" target="_blank">
