...
<head>
    <title><?= $this->config->item('app_name') ?> - Venda Nº#<?= e($result->idVendas) ?> - <?= e($result->nomeCliente) ?></title>
            ...
            <header>
                ...
                <?php else : ?>
                    ...
                    <div class="contatoEmitente">
                        ...
                        <span style="word-break: break-word;">Vendedor: <b><?= e($result->nome) ?></b></span>
                    </div>
                <?php endif; ?>
            </header>
            <section>
                <div class="title">
                    VENDA Nº#<?= str_pad(e($result->idVendas), 4, 0, STR_PAD_LEFT) ?>
