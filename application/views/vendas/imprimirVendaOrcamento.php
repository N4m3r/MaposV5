...
<head>
    <title><?= $this->config->item('app_name') ?> - Orçamento da Venda Nº#<?= e($result->idVendas) ?> - <?= e($result->nomeCliente) ?></title>
...
<body>
    <div class="main-page">
        <div class="sub-page">
            ...
            <section>
                <div class="title">
                    ORÇAMENTO DA VENDA Nº#<?= str_pad(e($result->idVendas), 4, 0, STR_PAD_LEFT) ?>
                ...
                <div class="dados">
                    <div>
                        ...
                        <span><?= e($result->contato.' '.$result->telefone) ?><?= $result->telefone && $result->celular ? ' / '.e($result->celular) : e($result->celular) ?></span><br />
                        <span><?= e($result->emailCliente) ?></span><br />
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php foreach ($produtos as $p) :
                                    ...
                                    echo '  <td class="text-center">' . e($p->quantidade) . '</td>';
            ...
            <footer>
                ...
                <div class="vendedor">
                    <span>Vendedor : <b><?php echo e($result->nome); ?> </b></span>
                </div>
            </footer>
        </div>
        </div>
