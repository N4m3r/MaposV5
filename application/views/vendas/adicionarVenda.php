                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    <div class="col-12" style="padding: 1%">
                                        <div class="col-2">
                                            ...
                                            <input id="dataVenda" class="col-12 datepicker" type="text" name="dataVenda" value="<?php echo date('d/m/Y'); ?>" />
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input id="garantia" type="number" placeholder="Em Dias" min="0" max="9999" class="col-12" name="garantia" value="" />
                                    ...
                                    <div class="col-12" style="padding: 1%; margin-left: 0">
                                        <div class="col-6 offset-md-3" style="display:flex;justify-content: center">
                                          <button class="button btn btn-success" id="btnContinuar"><span class="button__icon"><i class='bx bx-chevrons-right'></i></span><span class="button__text2">Continuar</span></button>
                                            <a href="<?php echo base_url() ?>index.php/vendas" class="button btn btn-sm btn-warning"><span class="button__icon"><i class="bx bx-undo"></i></span> <span class="button__text2">Voltar</span></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
