            ...
            <div class="widget-content nopadding">
                <form action="<?= current_url() ?>" method="post" class="form-horizontal">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <input type="text" name="nome" class="col-6" value="<?= set_value('nome') ?>" required />
                            <?= form_error('nome') ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <input type="email" name="email" class="col-6" value="<?= set_value('email') ?>" required />
                            <?= form_error('email') ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <input type="text" name="telefone" class="col-4" value="<?= set_value('telefone') ?>" id="telefone" placeholder="(00) 00000-0000" />
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <input type="password" name="senha" class="col-4" required minlength="6" />
                            <?= form_error('senha') ?>
                            <span class="form-text">Mínimo 6 caracteres</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <input type="password" name="confirmar_senha" class="col-4" required />
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <select name="cliente_id" class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <div class="input-group">
                                <select id="buscar-cliente-cnpj" class="col-6">
                            ...
                            <span class="form-text">Selecione um cliente cadastrado para preencher automaticamente o CNPJ</span>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <div id="cnpjs-container">
                                <div class="cnpj-row" style="margin-bottom: 10px;">
                                    <div class="input-group">
                                        <input type="text" name="cnpjs[]" class="col-4 cnpj-input" placeholder="00.000.000/0000-00" maxlength="18" />
                                    ...
                                    <input type="text" name="cnpjs_razao[]" class="col-6 cnpj-razao" placeholder="Razão Social (preenchido automaticamente)" readonly style="margin-top: 5px;" />
                                </div>
                            </div>
                            <button type="button" class="btn btn-success btn-sm" id="btn-adicionar-cnpj">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="controls">
                            <div class="col-8" style="background: #f9f9f9; padding: 15px; border: 1px solid #ddd; border-radius: 8px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; border-bottom: 2px solid #dee2e6; padding-bottom: 10px;">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-sm btn-info" id="btn-marcar-todos-add">
                                            <i class="bx bx-check-square"></i> Marcar Todos
                                        </button>
                                        <button type="button" class="btn btn-sm btn-default" id="btn-desmarcar-todos-add">
                                ...
                                foreach ($permissoesAgrupadasAdd as $grupo => $chaves): ?>
                                    <div class="grupo-permissoes" style="margin-bottom: 15px; background: #fff; border-radius: 6px; padding: 12px; border: 1px solid #e9ecef;">
                                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                            ...
                                            <button type="button" class="btn btn-sm btn-marcar-grupo-add" data-grupo="<?= md5($grupo) ?>">
    ...
    $('#btn-buscar-cliente').click(function() {
        ...
        if (linhaVazia) {
            ...
            var newRow = `
                <div class="cnpj-row" style="margin-bottom: 10px;">
                    <div class="input-group">
                        <input type="text" name="cnpjs[]" class="col-4 cnpj-input" placeholder="00.000.000/0000-00" maxlength="18" value="${cnpjFormatado}" />
                        <button type="button" class="btn btn-info btn-consultar-cnpj" title="Consultar na ReceitaWS">
                            <i class="bx bx-search"></i>
                        </button>
                        <button type="button" class="btn btn-danger btn-remover-cnpj" title="Remover">
                    ...
                    <input type="text" name="cnpjs_razao[]" class="col-6 cnpj-razao" placeholder="Razão Social (preenchido automaticamente)" readonly style="margin-top: 5px;" value="${razaoSocial}" />
                </div>
            `;
            $('#cnpjs-container').append(newRow);
        }
