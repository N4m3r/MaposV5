    ...
    <div class="main-page">
        <div class="sub-page">
            ...
            <section>
                ...
                <?php if (($totalProdutos != 0 || $totalServico != 0) && $permissao_eOs) : ?>
                    <div class="pagamento">
                        <div class="qrcode">
...
<!-- Debug: Total de assinaturas: <?php echo count($assinaturas ?? []); ?> -->
                <div class="assinaturas">
                    ...
                    if (!empty($assinaturas)) {
                        foreach ($assinaturas as $assinatura) {
                            if ($assinatura->tipo == 'cliente_saida') {
                                $assinaturaCliente = $assinatura;
                            }
                            if ($assinatura->tipo == 'tecnico_saida') {
        ...
        <?php if ($configuration['control_2vias']) : ?>
            <div class="sub-page novaPagina">
                ...
                <footer>
                    ...
                    <div class="assinaturas">
                        <?php
                        // Reutiliza as mesmas variáveis já definidas anteriormente
                        if (empty($assinaturaCliente) && empty($assinaturaTecnico) && !empty($assinaturas)) {
                            foreach ($assinaturas as $assinatura) {
                                if ($assinatura->tipo == 'cliente_saida') {
                                    $assinaturaCliente = $assinatura;
                                }
