    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = [
                ...
                'inscricao_municipal' => set_value('inscricao_municipal') ?: null,
                'inscricao_estadual' => set_value('inscricao_estadual') ?: null,
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($senha != null) {
                ...
                $data = [
                    ...
                    'inscricao_municipal' => $this->input->post('inscricao_municipal') ?: null,
                    'inscricao_estadual' => $this->input->post('inscricao_estadual') ?: null,
