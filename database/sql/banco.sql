...
CREATE TABLE IF NOT EXISTS `os_nfse_emitida` (
  ...
  `regime_tributario` ENUM('simples_nacional','lucro_presumido','lucro_real') NOT NULL DEFAULT 'simples_nacional' COMMENT 'Regime tributário da empresa na emissão',
  `valor_das` DECIMAL(15,2) DEFAULT NULL COMMENT 'Valor estimado do DAS (Simples Nacional)',
  ...
  `retem_iss` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Tomador retém ISS',
  `retem_irrf` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Tomador retém IRRF',
  `retem_pis` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Tomador retém PIS',
  `retem_cofins` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Tomador retém COFINS',
  `retem_csll` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Tomador retém CSLL',
  `valor_retencao_iss` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Valor ISS retido pelo tomador',
  `valor_retencao_irrf` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Valor IRRF retido pelo tomador',
  `valor_retencao_pis` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Valor PIS retido pelo tomador',
  `valor_retencao_cofins` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Valor COFINS retido pelo tomador',
  `valor_retencao_csll` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Valor CSLL retido pelo tomador',
  `valor_total_retencao` DECIMAL(15,2) NOT NULL DEFAULT 0.00 COMMENT 'Total das retenções do tomador',
  `competencia` DATE NULL COMMENT 'Mês/ano de competência da NFS-e',
